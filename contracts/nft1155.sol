...
contract nft1155 is ERC1155, ERC1155Pausable, ERC1155Supply {
    ...
    constructor()
        ERC1155(
            "https://salmon-legislative-lynx-655.mypinata.cloud/ipfs/QmeVP9LvVcecQcCPTeuPyJfSSDiBHNcSPAZGwmQ81s5xZS/"
        )
    {
        owner = msg.sender;
    }
    ...
    function editMintWindow(
        ...
        require(
            msg.sender == owner,
            "you cannot change it as only owner can do this"
        );
    ...
    function publicMint(uint256 id, uint256 amount) public payable {
        require(
            purchasesPetWallet[msg.sender] + amount <= maxPerWallet,
